...
//    -----------------------------------------------names----------------------------------------
    ...
    @Override public gneralcreating visitGrnral_creating(SQLParser.Grnral_creatingContext ctx) {
        ...
        {
            System.out.println(" check it in creating_with_assign");
    ...
    @Override public createvariablewithassign visitCreating_with_assign(SQLParser.Creating_with_assignContext ctx) {
        ...
        createvariablewithassign with  = new createvariablewithassign();
        ...
        if(ctx.create_json_with_assign()!=null)
        {
            ...
            with.setInstrucation_name(with.getJson_wiht_assign().getInstrucation_name());
        }
       else if(ctx.create_Array_with_assign()!=null)
        {

            with.setArray_with_assign(visitCreate_Array_with_assign(ctx.create_Array_with_assign()));
            with.setInstrucation_name(with.getArray_with_assign().getInstrucation_name());

        }

        if(ctx.create_varible_with_assign()!=null)
        {
         with.setVar_wiht_assign(visitCreate_varible_with_assign(ctx.create_varible_with_assign()));
         visitAssign_varible(ctx.create_varible_with_assign().assign_varible());
            with.setInstrucation_name(with.getVar_wiht_assign().getInstrucation_name());}
    ...
    @Override public return_type visitReturn_type(SQLParser.Return_typeContext ctx) {
        ...
        if (ctx.arithmetic_infunction_statment() != null) {
            System.out.println(" visit arithmatic infunction "+ctx.arithmetic_infunction_statment().getText().toString());
            t.setArithmatic(visitArithmetic_expr(ctx.arithmetic_expr()));
        }
    ...
    @Override public createwihtoutassign visitCreat_without_assign(SQLParser.Creat_without_assignContext ctx) {
        ...
        System.out.println(" visite creating without assign ");
    ...
    public function_body visitFunction_body(SQLParser.Function_bodyContext ctx) {
        ...
        instructions ins ;
        System.out.println("Number instruction  we still have "+ctx.sub_function_body().instructions().size());
  ...
  @Override public exting_oop visitExiting_loops(SQLParser.Exiting_loopsContext ctx) {
    ...
    public instructions visitInstructions(SQLParser.InstructionsContext ctx) {
        ...
        if(ctx.functional_instruction() != null)
        {
            ...
            System.out.println(".................."+ctx.functional_instruction().instructions().size());
        }
...
i.setLoop(visitExiting_loops((SQLParser.Exiting_loopsContext)ctx.if_rule().return_rule().K_RETURN()));
    ...
    public instructions visitDo_while(SQLParser.Do_whileContext ctx) {
        ...
        for (int i = 0; i <ctx.instructions().size() ; i++) {
            ins.addinstruction(visitInstructions(ctx.instructions(i))); /* not if we put the extingloop inside for of instruction
                                                                           do{retur p;}while(x<3);
                                                                           will not see the return rule
                                                                    */
    ...
    public arithmetic_infunction_statment visitArithmetic_infunction_statment(SQLParser.Arithmetic_infunction_statmentContext ctx) {
        ...
        if(ctx.full_arthmatic_statmint() != null) {
            //general.setInstrucation_name( gneralcreating.class.getName());
            arithmetic_infunction_statment.setInstrucation_name(arithmetic_infunction_statment.class.getName());
